...
public class SearchMetaDataImpl implements SearchMetaData, Serializable {
    ...
    public String toString() {
        return new StringBuffer("SearchMetaData[").append("name=").append(name).append(", label=").append(label).append(", description=").append(description).append(", dataSource=").append(dataSource).append(", tableSource=").append(tableSource).append(", searchEngineClass=").append(searchEngineClass).append(", spmds=").append(spmds).append(", rpmds=").append(rpmds).append(", rrpmds=").append(rrpmds).append(", srpmds=").append(srpmds).append(", srpmdos=").append(srpmdos).append("]").toString();
    }
}
